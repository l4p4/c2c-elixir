defmodule Mix.Tasks.Swagger.Gen do
  @shortdoc "Generates Swagger API restFul for resource"
  ...
  def files_to_be_generated(%Context{schema: schema, context_app: context_app}) do
    ...
    [
      {:eex, "controller.ex",
       Path.join([web_prefix, "controllers", web_path, "#{schema.singular}_controller_api.ex"])},
  ...
  def copy_new_files(%Context{} = context, paths, binding) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/swagger.gen", binding, files)
  ...
  def print_shell_instructions(%Context{schema: schema, context_app: ctx_app} = context) do
    if schema.web_namespace do
      ...
      Add the resource to your :api scope in #{Mix.Phoenix.web_path(ctx_app)}/router.ex:
          ...
          Move all content from controller_api generated to the #{inspect(schema.alias)}Controller

          Delete the generated controller_api and run the app
          Run mix phx.swagger.generate to generate swagger file
      """)
    end
